from telegram import InlineKeyboardButton, InlineKeyboardMarkup, Message, \
    BotCommand, MenuButtonCommands, BotCommandScopeChat, MenuButtonDefault, ReplyKeyboardMarkup
...
async def send_audio_mess(update: Update, context: ContextTypes.DEFAULT_TYPE,
                          file: str, rm):
    return await context.bot.send_audio(chat_id=update.effective_chat.id, audio=open(file, 'rb'), reply_markup=rm)
